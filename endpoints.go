...
var (
	...
	EndpointCallsV3 = EndpointV3 + "calls"

	EndpointAnonymousCallsV1 = EndpointV1 + "anonymous_calls"
	...
	EndpointGamesV1         = EndpointV1 + "games"
	EndpiontGenresV1        = EndpointV1 + "genres"
	...
	EndpointCallsBumpCall                             = func(cID int) string { return EndpointCallsV1 + "/" + strconv.Itoa(cID) + "/bump" }
	EndpointCallsGenerateActionSignature              = func() string { return EndpointCallsV1 + "/action_signature/generate" }
	EndpointCallsGetActiveCall                        = func() string { return EndpointPostsV1 + "/active_call" }
	EndpointCallsGetBGMs                              = func() string { return EndpointCallsV1 + "/bgm" }
	EndpointCallsGetCall                              = func(cID int) string { return EndpointCallsV2 + "/conferences/" + strconv.Itoa(cID) }
	EndpointCallsGetCallInvitableUsers                = func(cID int) string { return EndpointCallsV1 + "/" + strconv.Itoa(cID) + "/users/invitable" }
	EndpointCallsGetCallStatus                        = func(uID int) string { return EndpointCallsV1 + "/phone_status/" + strconv.Itoa(uID) }
	EndpointCallsGetGame                              = func() string { return EndpointGamesV1 + "/apps" }
	EndponitCallsGetGenres                            = func() string { return EndpiontGenresV1 }
	EndpointCallsGetGroupCalls                        = func() string { return EndpointPostsV1 + "/group_calls" }
	EndpointCallsGetRTMToken                          = func(cID int) string { return EndpointPostsV1 + "/" + strconv.Itoa(cID) + "agora_rtm_token" }
	EndpointCallsInviteToCallBulk                     = func(cID int) string { return EndpointCallsV1 + "/" + strconv.Itoa(cID) + "bulk_invite" }
	EndpointCallsInviteUsersToCall                    = func(cID int) string { return EndpointCallsV1 + "/conference_calls/" + strconv.Itoa(cID) + "/invite" }
	EndpointCallsInviteUsersToChatCall                = func() string { return EndpointCallsV2 + "/invite" }
	EndpointCallsKickFromCall                         = func(cID int) string { return EndpointCallsV3 + "/conference_calls/" + strconv.Itoa(cID) + "/kick" }
	EndpointCallsNotifyAnonymousUserLeaveAgoraChannel = func() string { return EndpointAnonymousCallsV1 + "/leave_agora_channel" }
	EndpointCallsNotifyUserLeaveAgoraChannel          = func() string { return EndpointCallsV1 + "/leave_agora_channel" }
	EndpiontCallsSendCallScreenshot                   = func() string { return EndpointCallsV1 + "/screenshot" }
	EndpointCallsSetCall                              = func(cID int) string { return EndpointCallsV1 + "/" + strconv.Itoa(cID) }
	EndpointCallsSetUserRole                          = func(cID int, uID int) string {
		return EndpointCallsV1 + "/" + strconv.Itoa(cID) + "/users/" + strconv.Itoa(uID)
	}
	EndpointCallsStartCall               = func() string { return EndpointCallsV2 + "/start_conference_call" }
	EndpointCallsLeaveCall               = func() string { return EndpointCallsV1 + "/leave_conference_call" }
	EndpointCallsValidateActionSignature = func() string { return EndpointCallsV2 + "/action_signature/validate" }
